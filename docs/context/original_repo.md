...
└── 09/
    ...
    │           │   ├── commit_message.txt
    │           │   └── diff_stats.txt
    │           ├── 17da216649bf33d890a939ff20b12b2e5c40b845/
    │           │   ├── analysis.md
    │           │   ├── analysis_summary.md
    │           │   ├── commit_message.txt
    │           │   ├── diff_stats.txt
    ...
    │           │   ├── diff_stats.txt
    │           │   └── full_diff.txt
    │           ├── 478dd831ee5722b18376137d1d98fa8aeac9cf07/
    │           │   ├── analysis_summary.md
    │           │   ├── commit_message.txt
    │           │   ├── diff_stats.txt
    │           │   └── full_diff.txt
    ...
    │           │   ├── diff_stats.txt
    │           │   └── full_diff.txt
    │           ├── aef1f9beabbd326cf1cc7b379c73c6e6a54a635d/
    │           │   ├── analysis_summary.md
    │           │   ├── commit_message.txt
    │           │   ├── diff_stats.txt
    │           │   └── full_diff.txt
    ...
    │   │   │   ├── bott8_pid_as_meme_meta_meme_spec.md
